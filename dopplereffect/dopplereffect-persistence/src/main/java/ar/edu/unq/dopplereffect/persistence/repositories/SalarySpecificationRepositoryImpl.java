...
public class SalarySpecificationRepositoryImpl extends
		HibernatePersistentRepository<SalarySpecification> {
	...
	public SalarySpecification getByPlanAndLevel(final CareerPlan plan,
