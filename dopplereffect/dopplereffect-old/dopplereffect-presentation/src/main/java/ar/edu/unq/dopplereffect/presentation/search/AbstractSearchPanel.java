...
public abstract class AbstractSearchPanel<T extends SearchPanelModel> extends AbstractCallbackPanel<T> {
    ...
    protected AjaxDataTablePage createAjaxTable() {
        return new AjaxDataTablePage(this, this.getTableWicketId(), this.getSortName(),
                ((SearchPanelModel<T>) this.getDefaultModelObject()), this.getCallback(), this.getFields(), this.getAbm());
    }
    ...
    protected String getBeanName() {
        return ((SearchPanelModel<T>) this.getDefaultModelObject()).getEntityType().getSimpleName();
    }
