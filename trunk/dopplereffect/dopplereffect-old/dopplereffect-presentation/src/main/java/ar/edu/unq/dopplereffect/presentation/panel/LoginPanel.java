    ...
    protected AjaxButton createSubmitButton() {
        return new AjaxButton("submit") {
            ...
            protected void onSubmit(final AjaxRequestTarget target, final Form<?> form) {
                ...
                state.submit(userName, password, LoginPanel.this, target);
            }
    ...
    protected AjaxLink<String> createRegisterButton() {
        return new AjaxLink<String>("register", this.getRegisterSubmitModel()) {
            ...
            public void onClick(final AjaxRequestTarget target) {
            	state.onLink(LoginPanel.this);
                target.addComponent(LoginPanel.this);
            }
        };
    }

    public void submitRegister(String userName, String password, AjaxRequestTarget target){
    	this.getService().signUp(userName, password, this.registerCallBack(target),
    			this.errorCallback());
    }
    public void submitLogin(String userName, String password, AjaxRequestTarget target){
