 ...
 */
public class EmployeeSearchPanel extends AbstractSearchPanel<SearchPanelModel<Employee>> {
    ...
    protected EmployeeAjaxDataTablePage createAjaxTable() {
        return new EmployeeAjaxDataTablePage(this, this.getTableWicketId(), this.getSortName(),
                ((SearchPanelModel<Employee>) this.getDefaultModelObject()), this.getCallback(), this.getFields(), this.getAbm());
    }
}
